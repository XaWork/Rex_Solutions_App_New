...
public class TravelTabsViewPagerAdapter extends FragmentPagerAdapter {
    ...
    public CharSequence getPageTitle(int position) {
        switch (position) {
            case (0):
                return context.getString(com.innomalist.taxi.common.R.string.tab_driver_info);
            case (1):
                return context.getString(com.innomalist.taxi.common.R.string.tab_statistics);
            case (2):
                return context.getString(com.innomalist.taxi.common.R.string.tab_review);
            default:
                return context.getString(com.innomalist.taxi.common.R.string.tab_driver_info);
        }
    }
